...
public class SecondPage {
    ...
    @FXML
    void FeeWindowShow(MouseEvent event) {loadUI("FeeWindow");}
    @FXML
    void UserWindowShow(MouseEvent event) {loadUI("UserWindow");}
    @FXML
    void BookWindowShow(MouseEvent event) {loadUI("BookWindow");}
