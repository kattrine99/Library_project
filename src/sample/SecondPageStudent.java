...
import java.sql.*;
public class SecondPageStudent {
    @FXML
    ...
    @FXML
    void FeeWindowShow(MouseEvent event) {
        loadUI("FeeWindowStudent");
    }


    @FXML
    void BookWindowShow(MouseEvent event) throws IOException {
        loadUI("BookWindowStudent");
